	...
	<div class="menu d-flex flex-column align-items-start justify-content-start menu_mm trans_400">
		...
		<nav class="menu_nav">
			<ul class="menu_mm">
				...
				<li class="menu_mm"><a href="#">Produk</a></li>
				<li class="menu_mm"><a href="#">Iklan Saya</a></li>
	...
	<div class="sidebar">
		...
		<nav class="sidebar_nav">
			<ul>
				...
				<li><a href="#">iklan saya<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
				...
				<div class="row">
					...
					<div class="col-lg-4 box_col">
						<div class="box">
							...
							<div class="box_title trans_200"><a href="categories.html">Fashion</a></div>
						</div>
					</div>
					...
					<div class="col-lg-4 box_col">
						<div class="box">
							<div class="box_image"><img src="images/box_5.jpg" alt=""></div>
							<div class="box_title trans_200"><a href="categories.html">Elektronik</a></div>
						</div>
					</div>
					...
					<div class="col-lg-4 box_col">
						<div class="box">
							<div class="box_image"><img src="images/box_6.jpg" alt=""></div>
							<div class="box_title trans_200"><a href="categories.html">Perlengkapan Rumah</a></div>
						</div>
					</div>
